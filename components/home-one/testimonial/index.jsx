...
const testimonialsData = [
	{
		id: safeRandomUUID(),
		rating: 5,
		title: "Harika müşteri hizmeti!",
		description:
			"Harika müşteri hizmeti ve benim alımım çok iyiydi, özellikle son dakika bir sipariş, zamanında geldi ve geldiğinde ben çok memnun kaldım, aldığım tasarım ve boyut da çok memnun kaldım ve aldığım kişi de aynı şekilde.",
		author: "William Jack",
